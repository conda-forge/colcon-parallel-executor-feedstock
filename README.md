About colcon-parallel-executor
==============================
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8123&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colcon-parallel-executor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colcon-parallel-executor` can be installed with:

```
conda install colcon-parallel-executor
```

It is possible to list all of the versions of `colcon-parallel-executor` available on your platform with:
